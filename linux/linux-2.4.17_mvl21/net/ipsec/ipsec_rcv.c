...
char ipsec_rcv_c_version[] = "RCSID $Id: ipsec_rcv.c,v 1.1.1.3 2005/08/25 06:27:03 sparq Exp $";
...
#endif /* PROTO_HANDLER_SINGLE_PARM */
{
	...
	*/
	...
	do {
		...
		/* zhangbin 2005.5.8 */
		//printk("%s:1:len=%d,iphlen=%d\n",__FUNCTION__,len,iphlen);
		
#ifdef CONFIG_IPSEC_ESP
		/* XXX this will need to be 8 for IPv6 */
		if ((proto == IPPROTO_ESP) && ((len - iphlen) % 4)) {
			/* zhangbin 2005.5.8 */
			//printk("%s:2:len=%d,iphlen=%d\n",__FUNCTION__,len,iphlen);
 ...
 *
 * Revision 1.1.1.2  2004/07/26 01:50:07  sparq
 * Mirror v1.00.01 release from K.C division of CyberTAN.
 *
