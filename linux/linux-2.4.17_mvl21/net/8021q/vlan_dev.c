                  ...
                  struct packet_type* ptype)
{
	...
	//zhangbin 2004-12-16
	{
        	unsigned short mapping_hash[8];
		mapping_hash[7] = mapping_hash[6] = mapping_hash[5] = 0xb8;
    		mapping_hash[4] = 0x88;
		mapping_hash[3] = 0x68;
	    	mapping_hash[2] = 0x48;
		mapping_hash[1] = 0x28;
	    	mapping_hash[0] = 0x0;
	    	//dscp_mapping = mapping_hash[(ntohs(vhdr->h_vlan_TCI) >> 13) & 0x7];
	    	skb->cos = mapping_hash[(ntohs(vhdr->h_vlan_TCI) >> 13) & 0x7];
		//printk("skb->cos=%02x\n",skb->cos);
	 }
#endif
