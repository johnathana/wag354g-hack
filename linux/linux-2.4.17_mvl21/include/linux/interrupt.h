...
/*
 * The ALWAYS_SOFTIRQ tasks will always be called repeatedly (until the pending
 * bit stays cleared) each time do_softirq is called.
 */
...
#if 0
static inline void trigger_softirq(void)
{
