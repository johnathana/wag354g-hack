 ...
 *
 * $Id: bcmnvram.h,v 1.1.1.2 2005/03/28 06:55:48 sparq Exp $
 */
...
extern int nvram_id_set(const char *name, const char *value, int id);
...
extern int nvram_set_notify(void (*cb)(int));
...
//#define NVRAM_SPACE		0x1d800 //0x8000
//#define NVRAM_SPACE		0xfc00
#if (FLASH_SIZE == 8)
	#define NVRAM_SPACE		0x1d400
#elif (FLASH_SIZE == 4)
	#define NVRAM_SPACE		0xd400
#endif
