 ...
 */
typedef PAL_Result (*DDC_DeleteInstance) (
        DDC_Handle  hDDC,
        Ptr         param);
 ...
 *  \return PAL_SUCCESS or PAL Error code
 */
typedef PAL_Result (*DDC_Control) (
            DDC_Handle  hDDC,
            Int         cmd,
            Ptr         cmdArg,
            Ptr         param);
 ...
 *  \return PAL_SUCCESS or PAL Error code
 */
typedef PAL_Result (*DDA_ControlCb) (
            DDA_Handle  hDDA,
            Int         cmd,
            Ptr         cmdArg,
            Ptr         param);
 ...
 *  \return PAL_SUCCESS or PAL Error code
 */
typedef PAL_Result (*DDC_CreateInstance) (
        Int                 instId,
        DDA_Handle          hDDA,
