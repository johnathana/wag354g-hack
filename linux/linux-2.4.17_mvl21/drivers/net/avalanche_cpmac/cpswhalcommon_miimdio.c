...
int cpswHalCommonMiiMdioInit(PHY_DEVICE *PhyDev, bit32u miibase, bit32u inst, bit32u PhyMask, bit32u MLinkMask, bit32u ResetReg, bit32u ResetBit, bit32u MdioBusFreq, bit32u MdioClockFreq,int verbose,int (*osprintf)(const char *Format, ...))
  {
...
void cpswHalCommonMiiMdioSetPhyMode(PHY_DEVICE *PhyDev,bit32u PhyMode)
  ...
  *PhyState&=~PHY_SMODE_MASK;
  ...
  if (MdioDebug)
    mdioPrintf("cpswHalCommonMiiMdioSetPhyMode:%08X Auto:%d, FD10:%d, HD10:%d, FD100:%d, HD100:%d\n", PhyMode,
