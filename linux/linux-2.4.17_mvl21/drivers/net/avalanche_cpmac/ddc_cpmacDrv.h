...
/** \file   ddc_cpmacDrv.h
    ...
    This file contains data structures and interfaces internal to CPMAC 
    specific DDC implementation.This file is compliant to the PSP Framework 1.0 
...
typedef struct
{
    Int32   hNext;      /**< next (hardware) buffer descriptor pointer */
    Int32   buffPtr;    /**< data buffer pointer */
    Int32   off_bLen;   /**< (buffer_offset_16)(buffer_length_16) */
    Int32   mode;       /**< SOP, EOP, Ownership, EOQ, Teardown, Q Starv, Length */
    Ptr     next;       /**< Pointer to the next TX buffer descriptor (linked list) */
    DDC_NetDataToken    bufToken;   /**< Data Buffer (OS) Token */
    Ptr     eopBD;      /**< Pointer to end of packet BD */ 
}CpmacTxBD;    
...
typedef volatile struct
{
    ...
    Int32   off_bLen;   /**< (buffer_offset_16)(buffer_length_16) */
    Int32   mode;       /**< SOP, EOP, Ownership, EOQ, Teardown, Q Starv, Length */
    Ptr     next;       /**< Pointer to the next RX buffer in BD queue */
...
typedef struct _CpmacRxCppiCh_t
{
    ...
    CpmacRxBD       *activeQueueHead;   /**< Head of active packet queue - next BD processed from here */
    ...
    DDC_NetBufObj   bufQueue[CPMAC_MAX_RX_FRAGMENTS];   /**< Buffers for a single packet */
#endif
...
#ifdef CPMAC_MULTIFRAGMENT
void cpmacAddBDToRxQueue(CpmacDDCObj *hDDC, CpmacRxCppiCh *rxCppi, CpmacRxBD *sopBD, CpmacRxBD *eopBD, Uint32 *buffer, DDC_NetDataToken *bufToken, Uint32 numBD);
#else
