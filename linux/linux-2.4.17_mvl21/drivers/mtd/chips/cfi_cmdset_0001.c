 ...
 *
 * $Id: cfi_cmdset_0001.c,v 1.1.1.2 2005/03/28 06:56:09 sparq Exp $
 *
 * 
...
#if defined(CONFIG_MIPS_ACPEP) || defined(CONFIG_MIPS_WA100)
	cfi_write(map, CMD(0x60), adr);
	cfi_write(map, CMD(0xD0), adr);
#endif	/* CONFIG_MIPS_ACPEP || CONFIG_MIPS_WA100 */
