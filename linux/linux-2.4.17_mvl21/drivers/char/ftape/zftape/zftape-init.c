...
char zft_src[] __initdata = "$Source: /home/cvsroot/src416v2/linux/linux-2.4.17_mvl21/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.2 $";
char zft_dat[] __initdata = "$Date: 2005/03/28 06:56:04 $";
