 ...
 * for more details.
 *
 * RCSID $Id: kernel.c,v 1.1.1.2 2005/03/28 06:57:44 sparq Exp $
 */
...
# define DEFAULT_UPDOWN	"/bin/ipsec/_updown"
#endif
...
//zhangbin
    ...
    //zhangbin
    //log("%s%s: cmd=%s", verb, verb_suffix, cmd);
	fclose(fy);
	 ...
	 * will remain.
	 */
	FILE *f = popen("/bin/ipsec/_updown", "r");
...
, struct state *st USED_BY_KLIPS)
{
	 ...
	 */
		...
		//zhangbin
	    //log("firewall_notified:%d",firewall_notified);
