 ...
 * for more details.
 *
 * RCSID $Id: constants.h,v 1.1.1.3 2005/08/25 06:27:25 sparq Exp $
 */
...
#ifdef DPD
#define DPD_ACTION_CLEAR        0
#define DPD_ACTION_HOLD         1
#endif
...
/*add by zhs for keep-alive
 */
#define POLICY_NOT_KEEPALIVE   LELEM(20)
#define IS_NOT_KEEPALIVE(p)   (((p) & POLICY_NOT_KEEPALIVE) !=0)  
...
//zhangbin -2004.4.12
#define SA_LIFE_DURATION_MAXIMUM    604800 /* seven days */
...
//zhangbin--2004.4.12
#define OAKLEY_ISAKMP_SA_LIFETIME_MAXIMUM 604800   /* seven days */
