 ...
 * for more details.
 *
 * RCSID $Id: x509.c,v 1.1.1.2 2005/03/28 06:57:44 sparq Exp $
 */
...
trusted_ca(chunk_t a, chunk_t b, int *pathlen)
{
    ...
    *pathlen = 0;
    ...
    {
	x509cert_t *cacert = get_x509cacert(a);
...
/*  Loads an optional OpenPGP certificate sent by FreeS/WAN to
