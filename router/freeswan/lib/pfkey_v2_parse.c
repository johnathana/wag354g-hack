 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_parse.c,v 1.1.1.2 2005/03/28 06:57:42 sparq Exp $
 */
...
char pfkey_v2_parse_c_version[] = "$Id: pfkey_v2_parse.c,v 1.1.1.2 2005/03/28 06:57:42 sparq Exp $";
