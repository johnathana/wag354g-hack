#!/bin/bash
#
# RCSID $Id: kernel.patch.gen.sh,v 1.1.1.2 2005/03/28 06:57:39 sparq Exp $
...
echo found $i
echo "RCSID \$Id: kernel.patch.gen.sh,v 1.1.1.2 2005/03/28 06:57:39 sparq Exp $" >$patchdir/$l
