...
char spi_c_version[] = "RCSID $Id: spi.c,v 1.1.1.2 2005/03/28 06:57:42 sparq Exp $";
 ...
 *
 * Revision 1.5  2003/05/26 12:47:12  ken
 * Relocate "; so GCC 3.3 is happier
 *
 * Revision 1.4  2003/04/14 16:08:37  jjo
 * . 1DES manual mode fix
 *
 * Revision 1.3  2003/03/11 14:49:29  jjo
 * . manual mode (spi) ESP_NULL relaxed checks
 *
 * Revision 1.2.4.1  2003/03/05 20:29:13  jjo
 * . missing changes for manual ESP_NULL support in spi.c
 *
