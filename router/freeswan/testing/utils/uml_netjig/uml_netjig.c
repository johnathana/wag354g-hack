 ...
 * for more details.
 *
 * RCSID $Id: uml_netjig.c,v 1.1.1.2 2005/03/28 06:57:46 sparq Exp $
 *
...
/*
 * $Log: uml_netjig.c,v $
 * Revision 1.1.1.2  2005/03/28 06:57:46  sparq
 * - GuangZhou release v1.00.57
 *
 * Revision 1.1.1.1  2004/07/26 01:39:28  sparq
 * Mirror v0.01.9 release from K.C division of CyberTAN.
 *
 * Revision 1.2  2002/11/05 01:51:44  ken
 * /testing tree from 1.99
 *
