 ...
 *
 * $Id: nvparse.c,v 1.1.1.2 2005/03/28 06:58:29 sparq Exp $
 */
...
get_forward_port(int which, netconf_nat_t *nat)
{
	...
	inet_aton(nvram_safe_get("wan_ipaddr"), &dstaddr);
	nat->match.dst.ipaddr.s_addr = dstaddr.s_addr;
...
//	nvram_unset("static_route"); //modified by leijun
}
