...
const int kNumFastBytesDefault = 0x40;
...
//  printf("lc=%d, lp=%d, pb=%d, whole byte = %x, dictionary size= %8.8x\n",
//		  m_LiteralContextBits, m_LiteralPosStateBits, m_PosStateBits, aByte, m_DictionarySize);
