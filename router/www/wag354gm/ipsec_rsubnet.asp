<TR>
          ...
          <TD>&nbsp;<INPUT class=num onblur="valid_range(this,0,255,'IP')" 
            ...
            onblur="valid_range(this,0,255,'IP')" maxLength=3 size=3 value='<% rtype_config("ipaddr",2); %>' name="r_ipaddr2"> . <INPUT class=num 
        ...
        <TR>
          ...
          <TD>&nbsp;<INPUT class=num onblur="valid_range(this,0,255,'Mask')" 
            maxLength=3 size=3 value='<% rtype_config("netmask",0); %>' name="r_netmask0"> . <INPUT 
            class=num onblur="valid_range(this,0,255,'Mask')" maxLength=3 size=3 
           value='<% rtype_config("netmask",1); %>' name="r_netmask1"> . <INPUT class=num 
            onblur="valid_range(this,0,255,'Mask')" maxLength=3 size=3 value='<% rtype_config("netmask",2); %>' name="r_netmask2"> . <INPUT class=num 
            onblur="valid_range(this,0,255,'Mask')" maxLength=3 size=3 value='<% rtype_config("netmask",3); %>' name="r_netmask3"></TD>
          <TD width=13>&nbsp;</TD>
          <TD width=15><IMG height=25 src="image/UI_05.gif" width=15 
            border=0></TD></TR>
        <TR>
