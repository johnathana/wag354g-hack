...
<tr>
<td colspan=2><font face=Arial color=blue><b><script>Capture(secother.vpnlog)</script></td>
</tr>
<tr>
<td align=right>
...
<option value="4"><script>Capture(secother.fwlog)</script></option>
<option value="2" selected><script>Capture(secother.vpnlog)</script></option>
</select>&nbsp
<input type=button value=' Clear ' onClick=ClearSubmit(this.form)>
&nbsp<input type=button value=' pageRefresh ' onClick=pagerefresh(this.form)></td>
</tr>
</table>
...
<td align=right>
<td align=right>
<!--<input type=button value=' Clear ' onClick=ClearSubmit(this.form)>--><script>document.write("<input type=button value='" + share.clear + "' onClick=ClearSubmit(this.form)>");</script>
