...
-->
  ...
  <TR>
		...
		<INPUT class=num maxLength=3 size=3 value='<% get_single_ip("wan_ipaddr","0"); %>' name="wan_ipaddr_0" onBlur=valid_range(this,0,255,"IP")> .
		...
		<INPUT class=num maxLength=3 size=3 value='<% get_single_ip("wan_gateway","0"); %>' name="wan_gateway_0" onBlur=valid_range(this,0,255,"IP")> .
		...
		<TR>
          ...
          <TD width=8 background=image/UI_04.gif height=25>&nbsp;</TD>
          <TD colSpan=3 height=25>&nbsp;</TD>
          <TD width=101 height=25>&nbsp;<script>Capture(setnetsetup.staticdns)</script> 1:&nbsp;</FONT></TD>
          <TD width=296 height=25><FONT style="FONT-SIZE: 8pt" 
            face=Arial><input type=hidden name="wan_dns" value="3">
		<INPUT class=num maxLength=3 size=3 value='<% get_dns_ip("wan_dns","0","0"); %>' name="wan_dns0_0" onBlur=valid_range(this,0,255,"IP")> .
		...
		<TR>
          ...
          <TD width=8 background=image/UI_04.gif height=25>&nbsp;</TD>
          <TD colSpan=3 height=25>&nbsp;</TD>
          <TD width=101 height=25>&nbsp;<script>Capture(setnetsetup.staticdns)</script> 2:&nbsp;</FONT></TD>
          <TD width=296 height=25><FONT style="FONT-SIZE: 8pt" face=Arial>
		<INPUT class=num maxLength=3 size=3 value='<% get_dns_ip("wan_dns","1","0"); %>' name="wan_dns1_0" onBlur=valid_range(this,0,255,"IP")> .
		...
		<TR>
          ...
          <TD width=8 background=image/UI_04.gif height=25>&nbsp;</TD>
          <TD colSpan=3 height=25>&nbsp;</TD>
          <TD width=101 height=25>&nbsp;<script>Capture(setnetsetup.staticdns)</script> 3:&nbsp;</FONT></TD>
          <TD width=296 height=25><FONT style="FONT-SIZE: 8pt" face=Arial>
		<INPUT class=num maxLength=3 size=3 value='<% get_dns_ip("wan_dns","2","0"); %>' name="wan_dns2_0" onBlur=valid_range(this,0,255,"IP")> .
