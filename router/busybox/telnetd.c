/* $Id: telnetd.c,v 1.1.1.1 2005/03/28 06:57:30 sparq Exp $
 *
...
//#else
//    printf("kirby debug: open /dev/ptyXX\n");
...
//        termbuf.c_lflag |=  ECHOE;
        termbuf.c_lflag |=  PENDIN;
        termbuf.c_oflag |= ONLCR;
        termbuf.c_oflag |= TAB0;
        termbuf.c_iflag |= ICRNL;
        termbuf.c_iflag &= ~IXOFF;
        termbuf.c_cc[VERASE] = 0177;
...
int telnetd_main(int argc, char **argv) {
    ...
    (void) setsockopt(master_fd, SOL_SOCKET, SO_REUSEADDR, &on,
                      sizeof(on));
