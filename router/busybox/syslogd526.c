...
//////////////////////songtao end
	...
	logMessage (LOG_SYSLOG | LOG_INFO, "1rsyslogd started: " BB_BANNER);
//////songtao 4.6.2004
...
/*	   if((time_zone[1]=='0')&&(time_zone[2]=='0'))
	   {
		   t_buff[9]='G';
		   t_buff[10]='M';
		   t_buff[11]='T';
         ...
         {  if(t_buff_i<=8)
			  t_buff_all[t_buff_i]=t_buff[t_buff_i];
			if(t_buff_i>=12)
			  t_buff_all[t_buff_i+8]=t_buff[t_buff_i];	
		 }
		 t_buff_all[9]='(';
		 t_buff_all[10]='G';
		 t_buff_all[11]='M';
		 t_buff_all[12]='T';
		 t_buff_all[13]=time_zone[0];
		 t_buff_all[14]=time_zone[1];
		 t_buff_all[15]=time_zone[2];
		 t_buff_all[16]=':';
		 t_buff_all[17]='0';
		 t_buff_all[18]='0';
		 t_buff_all[19]=')';
